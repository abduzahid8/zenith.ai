...
const AICoachTab: React.FC = () => {
    ...
    return (
        ...
        >
            {/* Title shown only when no messages */}
            {messages.length === 0 && (
                <>
...
const styles = StyleSheet.create({
    ...
    glassBackground: {
        ...
        borderRadius: scale(30),
        overflow: 'hidden',
        backgroundColor: 'rgba(255, 255, 255, 0.25)', // More transparent to show blur
        borderWidth: 2,
        borderColor: 'rgba(255, 255, 255, 0.4)',     // Base border
        borderTopColor: 'rgba(255, 255, 255, 1)',    // Top highlight rim
        borderLeftColor: 'rgba(255, 255, 255, 0.9)', // Left highlight rim
    },
    suggestionText: {
