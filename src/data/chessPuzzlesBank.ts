...
export const day3_opening_initiative: ChessPuzzle[] = [
  {
    ...
    prompt: "Ферзь соперника вышел слишком рано.\nИспользуй развитие с темпом.",
    hints: {
  ...
  },
  {
    ...
    prompt: "Центр открыт для борьбы. Найди\nразвивающий ход, создающий давление.",
    hints: {
  ...
  },
  {
    ...
    prompt: "Соперник потратил темп на лишний маневр.\nЗаставь его защищаться.",
    hints: {
  ...
  },
  {
    ...
    prompt: "Не уходи в пассивную оборону. Найди\nактивный развивающий ход с угрозой.",
    hints: {
  ...
  },
  {
    ...
    prompt: "Черный конь на f6 связан. Разрушь\nего защиту и займи центр с темпом.",
    hints: {
  ...
  },
  {
    ...
    prompt: "Соперник грозит быстрым матом, но\nего ферзь уязвим. Перехвати инициативу.",
    hints: {
  ...
  },
  {
    ...
    prompt: "Борьба за центр обостряется. Завладей\nпространством с активным нападением.",
    hints: {
...
export const chessLessonPuzzles: Record<string, ChessPuzzle[]> = {
  day1_board_geometry: [
    ...
    },
    {
      ...
      prompt: "Конь под атакой —\nнайди безопасное поле!",
      hints: {
    ...
    },
    {
      ...
      prompt: "В защите черных наметилась брешь.\nНайди их уязвимое место.",
      hints: {
    ...
    },
    {
      ...
      prompt: "Прямое взятие не работает —\nищи обходной путь.",
      hints: {
    ...
    },
    {
      ...
      prompt: "Король черных остался без прикрытия.\nНачни атаку совместными силами.",
      hints: {
  ...
  day2_piece_value: [
    {
      ...
      prompt: "Найди незащищённую фигуру\nи возьми её!",
      hints: {
    ...
    },
    {
      ...
      prompt: "Ферзь соперника под боем —\nиспользуй!",
      hints: {
    ...
    },
    {
      ...
      prompt: "Используй шах,\nчтобы выиграть фигуру!",
      hints: {
    ...
    },
    {
      ...
      moves: ["c3d5"],
      prompt: "Одна пешка защищена —\nвыбери правильное взятие!",
      hints: [
    ...
    },
    {
      ...
      prompt: "Шах с двойным нападением —\nвыиграй фигуру!",
      hints: {
