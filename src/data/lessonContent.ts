    ...
    do: {
      ...
      puzzles: [
        ...
        },
        {
          ...
          prompt: "Противник предлагает размен. Найди безопасную добычу и не попадайся в ловушку.",
          hints: [
        ...
        },
        {
          ...
          prompt: "У твоего слона есть выбор из двух взятий. Какое принесет тебе наибольший перевес?",
          hints: [
        ...
        },
        {
          ...
          prompt: "Противник защитил своего слона, но оставил короля уязвимым. Используй шах, чтобы выиграть фигуру.",
          hints: [
        ...
        },
        {
          ...
          prompt: "Используй своего слона для шаха с двойным нападением и выиграй тяжелую фигуру.",
          hints: [
