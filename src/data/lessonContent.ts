      ...
      puzzles: [
        {
          ...
          moves: ['e1e2'],
          prompt: 'Король ходит на одну клетку в любую сторону.\nСделай шаг королем вперед.',
          hints: [
        ...
        },
        {
          ...
          moves: ['a1a7'],
          prompt: 'Ладья ходит по горизонтали и вертикали.\nЗабери черную ладью!',
          hints: [
        ...
        },
        {
          ...
          moves: ['c1g5'],
          prompt: 'Слон ходит только по диагоналям своего цвета.\nЗабери незащищенного коня.',
          hints: [
        ...
        },
        {
          ...
          moves: ['d1h5'],
          prompt: 'Ферзь сочетает силу ладьи и слона.\nЗабери черную пешку на краю доски.',
          hints: [
        ...
        },
        {
          ...
          moves: ['g1f3'],
          prompt: 'Конь ходит необычным Г-образным ходом.\nСделай ход конем в центр.',
          hints: [
        ...
        },
        {
          ...
          moves: ['e2e4'],
          prompt: 'Сделай первый ход королевской пешкой\nсразу на две клетки вперед.',
          hints: [
        ...
        },
        {
          ...
          moves: ['e4d5'],
          prompt: 'Пешка ходит прямо, а бьет по диагонали.\nЗабери черную пешку!',
          hints: [
        ...
        },
        {
          ...
          moves: ['b1d2'],
          prompt: 'Черная пешка объявила шах королю.\nЗабери ее своим конем!',
          hints: [
      ...
      puzzles: [
        {
          ...
          prompt: "Найди беззащитную фигуру черных\nи выиграй её своей ладьей.",
          hints: [
        ...
        },
        {
          ...
          prompt: "Черный ферзь оказался под твоим боем.\nИспользуй это для выгодного размена.",
          hints: [
        ...
        },
        {
          ...
          prompt: "Противник предлагает размен фигурами.\nЗабери пешку и не попадись в ловушку.",
          hints: [
        ...
        },
        {
          ...
          prompt: "Слон может забрать две разные фигуры.\nВыбери наиболее выгодное взятие.",
          hints: [
        ...
        },
        {
          ...
          prompt: "Используй шах королю, чтобы следующим ходом\nвыиграть незащищенную фигуру черных.",
          hints: [
        ...
        },
        {
          ...
          moves: ['c3d5'],
          prompt: 'Одна из пешек противника защищена другой.\nВыбери безопасное взятие пешки.',
          hints: [
        ...
        },
        {
          ...
          prompt: "Сделай двойной удар (вилку) конем,\nчтобы выиграть ладью соперника.",
          hints: [
        ...
        },
        {
          ...
          prompt: "Объяви шах слоном с двойным ударом,\nчтобы выиграть ладью черных.",
          hints: [
      ...
      puzzles: [
        {
          fen: 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1',
          moves: ['e2e4'],
          prompt: 'Принцип №1: борись за центр!\nСходи королевской пешкой на поле e4.',
          hints: [
            'Ход e2-e4 открывает дорогу твоему слону и ферзю.',
            'Сделай широкий шаг этой пешкой на два поля вперед.',
            'Сыграй e2e4.'
        ...
        },
        {
          ...
          moves: ['e7e5'],
          prompt: 'За черных: ответь пешкой на e5,\nчтобы заявить свои права на центр.',
          hints: [
        ...
        },
        {
          ...
          moves: ['g1f3'],
          prompt: 'Принцип №2: развивай фигуры!\nВыведи коня на f3, атакуя пешку.',
          hints: [
        ...
        },
        {
          ...
          moves: ['b8c6'],
          prompt: 'За черных: выведи коня на c6,\nчтобы защитить свою пешку e5.',
          hints: [
        ...
        },
        {
          ...
          moves: ['f1c4'],
          prompt: 'Выведи слона на c4, атакуя самое\nслабое поле черных — f7.',
          hints: [
        ...
        },
        {
          ...
          moves: ['g8f6'],
          prompt: 'За черных: развивай коня на f6\nи контратакуй белую пешку e4.',
          hints: [
        ...
        },
        {
          ...
          moves: ['e1g1'],
          prompt: 'Принцип №3: сделай рокировку, чтобы\nспрятать короля в безопасный угол.',
          hints: [
        ...
        },
        {
          ...
          moves: ['f8c5'],
          prompt: 'За черных: выведи слона на c5,\nподготавливая рокировку короля.',
          hints: [
