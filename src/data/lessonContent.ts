...
const chessLessons: LessonContent[] = [
      ...
      puzzles: [
        {
          ...
          moves: ['e1e2'],
          prompt: 'Король ходит на одну клетку в любую сторону. Сделай шаг королем вперед.',
          hints: [
        ...
        },
        {
          ...
          moves: ['a1a7'],
          prompt: 'Ладья ходит по прямой (горизонтально и вертикально). Забери черную ладью!',
          hints: [
        ...
        },
        {
          ...
          moves: ['c1g5'],
          prompt: 'Слон ходит только по диагоналям своего цвета. Забери незащищенного коня.',
          hints: [
        ...
        },
        {
          ...
          moves: ['d1h5'],
          prompt: 'Ферзь сочетает силу ладьи и слона. Забери черную пешку на краю доски.',
          hints: [
        ...
        },
        {
          ...
          moves: ['g1f3'],
          prompt: 'Конь ходит буквой «Г» (перепрыгивая фигуры). Сделай ход конем в центр.',
          hints: [
        ...
        },
        {
          ...
          moves: ['e2e4'],
          prompt: 'Сделай первый ход королевской пешкой сразу на две клетки вперед.',
          hints: [
        ...
        },
        {
          ...
          moves: ['e4d5'],
          prompt: 'Пешка ходит только прямо, а бьет по диагонали. Забери черную пешку!',
          hints: [
        ...
        },
        {
          ...
          moves: ['b1d2'],
          prompt: 'Черная пешка объявила шах королю. Забери ее своим конем!',
          hints: [
      ...
      puzzles: [
        {
          ...
          prompt: "Найди фигуру противника, которая осталась без защиты, и выиграй её.",
          hints: [
        ...
        },
        {
          ...
          prompt: "Черный ферзь оказался под боем. Используй это для выгодного размена.",
          hints: [
        ...
        },
        {
          ...
          prompt: "Противник предлагает размен. Забери фигуру и не попадись в ловушку.",
          hints: [
        ...
        },
        {
          ...
          prompt: "Выбери наиболее выгодное взятие для твоего слона.",
          hints: [
        ...
        },
        {
          ...
          prompt: "Используй шах королю, чтобы выиграть незащищенную фигуру.",
          hints: [
        ...
        },
        {
          ...
          moves: ['c3d5'],
          prompt: 'Одна из пешек противника защищена, а другая нет. Выбери безопасное взятие.',
          hints: [
        ...
        },
        {
          ...
          prompt: "Объяви двойной удар (вилку), чтобы выиграть ладью соперника.",
          hints: [
        ...
        },
        {
          ...
          prompt: "Объяви шах слоном с двойным ударом и выиграй тяжелую фигуру.",
          hints: [
  ...
  },
  {
    ...
    do: {
      type: 'chess_puzzle',
      prompt: 'Реши серию из 7 задач на развитие инициативы в дебюте!',
      ...
      puzzles: [
        {
          fen: 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1',
          moves: ['e2e4'],
          prompt: 'Принцип №1: борись за центр! Сходи королевской пешкой на поле e4.',
          hints: [
            'Ход e2-e4 открывает дорогу твоему слону и ферзю.',
            'Сделай широкий шаг этой пешкой на два поля вперед.',
            'Сыграй e2e4.'
        ...
        },
        {
          ...
          moves: ['e7e5'],
          prompt: 'За черных: ответь пешкой на e5, чтобы заявить свои права на центр.',
          hints: [
        ...
        },
        {
          ...
          moves: ['g1f3'],
          prompt: 'Принцип №2: развивай фигуры! Выведи коня на f3, атакуя пешку.',
          hints: [
        ...
        },
        {
          ...
          moves: ['b8c6'],
          prompt: 'За черных: выведи коня на c6, чтобы защитить свою пешку e5.',
          hints: [
        ...
        },
        {
          ...
          moves: ['f1c4'],
          prompt: 'Выведи слона на c4, атакуя самое слабое поле черных — f7.',
          hints: [
        ...
        },
        {
          ...
          moves: ['g8f6'],
          prompt: 'За черных: развивай коня на f6 и контратакуй белую пешку e4.',
          hints: [
        ...
        },
        {
          ...
          moves: ['e1g1'],
          prompt: 'Принцип №3: сделай рокировку, чтобы спрятать короля в безопасный угол.',
          hints: [
        ...
        },
        {
          ...
          moves: ['f8c5'],
          prompt: 'За черных: выведи слона на c5, подготавливая рокировку короля.',
          hints: [
