...
const chessLessons: LessonContent[] = [
  {
    ...
    do: {
      type: 'chess_puzzle',
      prompt: 'Реши тренировочную серию из восьми обучающих задач на правила движения всех фигур!',
  ...
  },
  {
    ...
    do: {
      type: 'chess_puzzle',
      prompt: 'Реши серию из восьми интерактивных задач на тему короткой и длинной рокировки.',
      ...
      puzzles: [
        {
          ...
          moves: ['e1g1'],
          prompt: 'Обезопась белого короля. Сделай короткую рокировку в сторону королевского фланга.',
          hints: [
        ...
        },
        {
          fen: 'r3k2r/8/8/8/8/8/8/R3K2R w KQkq - 0 1',
          moves: ['e1c1'],
          prompt: 'Попробуй сделать длинную рокировку за белых, уводя короля на ферзевый фланг.',
          hints: [
        ...
        },
        {
          ...
          moves: ['e8g8'],
          prompt: 'Сделай короткую рокировку за черного короля, уводя его на безопасный правый фланг.',
          hints: [
        ...
        },
        {
          fen: 'r3k2r/8/8/8/8/8/8/R3K2R b KQkq - 0 1',
          moves: ['e8c8'],
          prompt: 'Сделай длинную рокировку за черных, надежно пряча короля на ферзевом фланге доски.',
          hints: [
        ...
        },
        {
          ...
          moves: ['g1f3'],
          prompt: 'Путь к рокировке закрыт конем. Выведи фигуру в центр, освобождая дорогу ладье.',
          hints: [
        ...
        },
        {
          ...
          moves: ['b1c3'],
          prompt: 'Начальный конь мешает рокировке. Выведи его вперед, освобождая путь для короля.',
          hints: [
        ...
        },
        {
          ...
          moves: ['e1f1'],
          prompt: 'Король под шахом ладьи соперника. Рокироваться сейчас нельзя — просто отступи.',
          hints: [
        ...
        },
        {
          ...
          moves: ['e1g1'],
          prompt: 'Вражеский слон простреливает путь. Рокируй в другую, безопасную сторону доски.',
          hints: [
